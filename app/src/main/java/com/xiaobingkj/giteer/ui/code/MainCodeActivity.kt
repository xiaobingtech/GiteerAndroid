package com.xiaobingkj.giteer.ui.code
...
import com.xiaobingkj.giteer.databinding.ActivityMainCodeBinding
import io.github.rosemoe.sora.app.LspTestActivity
...
class MainCodeActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()

        CrashHandler.INSTANCE.init(this)
        binding = ActivityMainCodeBinding.inflate(layoutInflater)
...
//            }
    ...
    private lateinit var binding: ActivityMainCodeBinding
