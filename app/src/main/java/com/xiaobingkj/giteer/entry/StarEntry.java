...
public class StarEntry implements Serializable {
    private List<StarEntryAssignee> assignee;
    private Integer assignees_number;
    private StarEntryAssigner assigner;
    ...
    private StarEntryEnterprise enterprise;
    ...
    private String name;
    private StarEntryNamespace namespace;
    private String notifications_url;
    private Integer open_issues_count;
    private Boolean outsourced;
    private StarEntryOwner owner;
    private String paas;
    private StarEntryParent parent;
    private String path;
    @SerializedName("private")
    private Boolean isPrivate;
    private List<StarEntryPrograms> programs;
    private String project_creator;
    private List<StarEntryProjectLabels> project_labels;
    ...
    private List<StarEntryTesters> testers;
    private Integer testers_number;
    private String updated_at;
    private String url;
    private Integer watchers_count;

    public List<StarEntryAssignee> getAssignee() {
        return assignee;
    }

    public void setAssignee(List<StarEntryAssignee> assignee) {
    ...
    public StarEntryAssigner getAssigner() {
        return assigner;
    }

    public void setAssigner(StarEntryAssigner assigner) {
    ...
    public StarEntryEnterprise getEnterprise() {
        return enterprise;
    }

    public void setEnterprise(StarEntryEnterprise enterprise) {
    ...
    public StarEntryNamespace getNamespace() {
        return namespace;
    }

    public void setNamespace(StarEntryNamespace namespace) {
    ...
    public StarEntryOwner getOwner() {
        return owner;
    }

    public void setOwner(StarEntryOwner owner) {
        this.owner = owner;
    }
    ...
    public StarEntryParent getParent() {
        return parent;
    }

    public void setParent(StarEntryParent parent) {
        this.parent = parent;
    }
    ...
    public List<StarEntryPrograms> getPrograms() {
        return programs;
    }

    public void setPrograms(List<StarEntryPrograms> programs) {
    ...
    public List<StarEntryProjectLabels> getProject_labels() {
        return project_labels;
    }

    public void setProject_labels(List<StarEntryProjectLabels> project_labels) {
    ...
    public List<StarEntryTesters> getTesters() {
        return testers;
    }

    public void setTesters(List<StarEntryTesters> testers) {
